...
@section('contenido')
    ...
    <div class="md-card">
        <div class="md-card-content">
            {!! Form::model($listafuente, ['route'=>['listadoFuenteCalle.update', $listafuente], 'method'=>'PUT']) !!}
                ...
                <div class="uk-width-medium-1">
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper md-input-filled"><label>Educador/ra:</label>
                            {!!Form::text('educador',$user,['class'=>'md-input', 'disabled'])  !!}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Observación:</label>
                            {!!Form::text('observacion',null,['class'=>'md-input','required'])  !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
