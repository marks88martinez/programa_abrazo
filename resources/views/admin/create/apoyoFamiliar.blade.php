...
@section('contenido')
    ...
    <div class="md-card">
        <div class="md-card-content">
            {!! Form::open(['route'=>'apoyofamiliar.store', 'method'=>'POST']) !!}
                ...
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Nombre Titular:</label>
                            {!! Form::text('nombretitular',null, ['class'=>'md-input','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Visita Numero:</label>
                            {!! Form::number('visita',null, ['class'=>'md-input','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
                    ...
                    <div class="uk-width-row">
                        ...
                        <p>
                            {!! Form::radio('etapa', '1', null,['id'=>'radio_demo_1','data-md-icheck'=>'','checked']) !!}
                            <label for="radio_demo_1" class="inline-label">1ra Etapa</label>
                        </p>
                        <p>
                            {!! Form::radio('etapa', '2', null,['id'=>'radio_demo_2','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_2" class="inline-label">2da Etapa</label>
                        </p>
                        <p>
                            {!! Form::radio('etapa', '3', null,['id'=>'radio_demo_3','data-md-icheck'=>'']) !!}
                    ...
                    <div class="uk-width-row">
                        ...
                        <p>
                            {!! Form::radio('Dimension', '1', null,['id'=>'radio_demo_4','data-md-icheck'=>'','checked']) !!}
                            <label for="radio_demo_4" class="inline-label">Identificación</label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '2', null,['id'=>'radio_demo_5','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_5" class="inline-label">Salud</label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '3', null,['id'=>'radio_demo_6','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_6" class="inline-label">Educación</label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '4', null,['id'=>'radio_demo_7','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_7" class="inline-label">Empleo/Ingresos</label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '5', null,['id'=>'radio_demo_8','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_8" class="inline-label">Seguridad AlimentariaSaneamiento Básico </label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '6', null,['id'=>'radio_demo_9','data-md-icheck'=>'']) !!}
                            <label for="radio_demo_9" class="inline-label">Dinámica Familiar</label>
                        </p>
                        <p>
                            {!! Form::radio('Dimension', '7', null,['id'=>'radio_demo_10','data-md-icheck'=>'']) !!}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Descripcion :</label>
                            {!! Form::textarea('descrip',null, ['class'=>'md-input','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Resultados :</label>
                            {!! Form::textarea('resultados',null, ['class'=>'md-input','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper"><label>Acuerdos :</label>
                            {!! Form::textarea('acuerdos',null, ['class'=>'md-input','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper md-input-filled"><label>Proxima Visita :</label>
                            {!! Form::date('pvisita', null,['class'=>'md-input', 'id'=>'uk-width-medium-1-3', 'data-uk-datepicker'=>'{format:"DD.MM.YYYY"}','required']) !!}
                            <span class="md-input-bar"></span></div>
                    </div>
                    {{--fin primera columna--}}
