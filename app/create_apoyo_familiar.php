...
class create_apoyo_familiar extends Model
{
    ...
    protected $fillable = ['id_educador','centro','nombre_titular','domicilio','visita_numero','etapa_seguimiento','dimensiones_t','Descripción','resultados','acuerdos','proxima_visita'];
